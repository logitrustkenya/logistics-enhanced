            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                {passwordValidation.showValidation && (
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <span className={passwordValidation.lengthValid ? 'text-green-400' : 'text-red-400'}>
              ...
              <div className="space-y-2">
                ...
                {passwordValidation.showValidation && formData.confirmPassword.length > 0 && (
                  <div className="flex items-center space-x-2 text-sm">
                    ...
                    <span className={passwordValidation.matchValid ? 'text-green-400' : 'text-red-400'}>
                      Passwords match
                    </span>
                  </div>
                )}
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  className="border-gray-600 data-[state=checked]:bg-lime-400 data-[state=checked]:border-lime-400 data-[state=checked]:text-gray-900"
                  required
                />
                <label
                  htmlFor="agreeTerms"
